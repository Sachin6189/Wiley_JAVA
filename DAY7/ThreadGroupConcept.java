...
public class ThreadGroupConcept {
    public static void main(String[] args) {
        ...
        ThreadGroup tgChild1 = new ThreadGroup("Child Group");
        ...
        System.out.println("Active group oƒ threads:- " + tgParent.activeCount());
        System.out.println("Active group of child:- " + tgChild1.activeCount());
